    ...
    <div class="main">
      ...
      <div class="container">
        <label
          class="center"
          for="Provider"
        ><strong>Battery Provider:</strong></label> <br>
        <select
          id="selectProvider"
      ...
      <br>
      <h5 class="center">
        Step # 2: Negotiate the edc contract
      </h5><br>
      <div class="container">
        <label
          class="center"
          for="contractOffer"
        ><strong>Contract Offers:</strong></label><br>
        <select
          id="selectOffer"
      ...
      <div class="container">
        <label
          class="center"
          for="Battery"
        ><strong>Battery:</strong></label><br>
        <select
          id="selectBattery"
      ...
      <br>
      <h5 class="center">
        Step # 3: Get battery passport from the provider
      </h5><br>
      <div class="container">
        <button
          :disabled="isDisabled"
